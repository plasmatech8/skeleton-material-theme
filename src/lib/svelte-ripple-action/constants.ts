...
const OUTEVENTS = ['pointerup', 'mouseleave', 'dragleave', 'touchmove', 'touchend', 'touchcancel'];
...
export { CENTER_CLASS, CLASS, INEVENTS, OUTEVENTS, addEvent, findFurthestPoint, removeEvent };
